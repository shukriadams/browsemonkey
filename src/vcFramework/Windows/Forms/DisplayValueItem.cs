...
namespace vcFramework.Windows.Forms
{
	...
	/// <summary>
	/// Struct Used to populate Combobox, listboxes, checkeslistboxes and other controls
	/// which can have a display and a value member
	/// </summary>
	public struct DisplayValueItem
	{
		...
		public DisplayValueItem(string strValueMember, string strDisplayMember)
		{
